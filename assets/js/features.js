...
(function () {
  ...
  var KB = [
    ...
    { k: /项目|做过|作品|经历|\bprojects?\b|\bworks?\b|portfolio/i,
      zh: "心雅的作品集现在有九项作品：《金陵残梦》、衍生宇宙、《狸的旅行日记》、《闹鬼农场》、《玛卡薇·缚命船医》、AI 赋能游戏项目管理、无畏契约娱乐水友赛、《记忆当铺》、《你就是系统》。它们覆盖游戏设计、团队协作、赛事活动与视觉表达；卡墙和各项目章节都有对应材料。",
      en: "Her portfolio now has nine projects: Remnant Dream of Jinling, the Jinling spin-off universe, Lico’s Travel Diary, Haunted Farm, Makavi, AI-Empowered Game PM, the VALORANT Community Cup, The Memory Pawnshop, and You Are The System. Together they cover game design, teamwork, events and visual expression. Each has a project card and supporting materials." },
