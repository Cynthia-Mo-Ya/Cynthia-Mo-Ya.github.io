...
(function () {
  ...
  var D = {
    ...
    'hero.st4': { zh: '光核共创营一期', en: 'LIGHTSPEED Camp S1' },
    'hero.st4s': { zh: '光子工作室群 · 结业总分第一', en: 'LIGHTSPEED STUDIOS · No.1 overall at graduation' },
    'hero.st2u': { zh: '件', en: '' },
    'hero.st2': { zh: '作品档案', en: 'Portfolio Files' },
    ...
    'file.s2': { zh: '· 系统 / 叙事 / 关卡设计<br>· 7 件作品档案<br>· 8 人团队主策划兼统筹 ×2', en: '· Systems / narrative / level design<br>· 7 portfolio files<br>· Lead & coordinator of 8-person team ×2' },
