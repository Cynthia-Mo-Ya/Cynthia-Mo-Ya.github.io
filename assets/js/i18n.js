...
(function () {
  ...
  var D = {
    ...
    'hero.st4': { zh: '结业总分第一', en: 'Top Overall Score' },
    'hero.st4s': { zh: '光子「光核共创营」一期', en: "LIGHTSPEED STUDIOS' camp S1" },
    'hero.st2u': { zh: '件', en: '' },
    ...
    'decode.meta': { zh: '把名字拆开，就是我的能力清单', en: 'Spell out the name — it reads as my skill list' },
    ...
    'spider.welcome': { zh: '嗨！我是心雅的蜘蛛 🕷️ 作品、设计、统筹、AI 工作流、为什么是《红楼梦》……问点真的。', en: 'Hi! I am Cynthia\'s spider 🕷️ Works, design, coordination, AI workflow, why Dream of the Red Chamber… ask me something real.' },
    ...
    'build.b6t': { zh: '美术表达', en: 'Art' },
    'build.b6s': { zh: '2D 角色 / 场景构图 / 漫画分镜 · 科班出身', en: '2D characters / scenes / storyboards · art-school trained' },
    ...
    'about.p1': { zh: '游戏设计', en: 'Game Design' },
    'about.p1d': { zh: '系统 / 叙事 / 关卡——从完整策划案与文学 IP 转译，到 UE5 白盒垂直切片与英雄数值平衡。', en: 'Systems / narrative / levels — from full design docs and literary-IP adaptation to UE5 white-box slices and champion balance.' },
    'about.p2': { zh: '项目统筹', en: 'Project Coordination' },
    'about.p2d': { zh: '两次带 8 人团队主策划兼统筹——定分工、写台本、做培训、盯节点；以 LOLM 为蓝本推演 PM 全链路，落地在线风险看板。', en: 'Twice lead & coordinator of an 8-person team — set the split, wrote the scripts, ran the training, tracked the milestones; plus a full PM playbook on LOL Mobile with a live risk dashboard.' },
    'about.p3': { zh: '美术功底', en: 'Art Foundation' },
